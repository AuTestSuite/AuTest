...
@nox.session(python=["pyston3", "3.6", "3.7", "3.8", "3.9", "3.10"], name="passing")
...
@nox.session(python=["pyston3", "3.6", "3.7", "3.8", "3.9", "3.10"], name="failing")
...
@nox.session(python=["pyston3", "3.6", "3.7", "3.8", "3.9", "3.10"], name="site")
