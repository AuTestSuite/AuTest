...
class Lambda(tester.Tester):
    ...
    def test( self,eventinfo, **kw ):
        ...
        try:
            ...
            result,desc,message=(True,"Exception was caught!",traceback.format_exc())
        ...
        host.WriteVerbose(["testers.Lambda","testers"],"{0} - ".format(tester.ResultType.to_color_string(self.Result)),self.Reason)
