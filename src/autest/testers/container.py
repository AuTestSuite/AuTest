...
class Any(_Container):
    def __init__(self, *lst):   
        super(Any, self).__init__(*lst, description = "Checking that any test passes")        
...
class All(_Container):
    def __init__(self, *lst):   
        super(All, self).__init__(*lst, description = "Checking that all tests pass")
...
class Not(_Container):
    def __init__(self, tester):   
        super(Not, self).__init__(tester, description = "Checking that negation of the test")
    ...
    def test( self,eventinfo, **kw ):
        ...
        # if Warning is clarified better, we might want it to be an error as well
