...
class Order(object):
    ...
    def StartBefore(self, *lst, **kw):
        ...
        for obj in lst:
            ...
            host.WriteDebugf(["startbefore"], "Setting ready logic to wait for object {0} with readyfunc {1}", obj, readyfunc)
    ...
    def StartAfter(self, *lst, **kw):
        ...
        for obj in lst:
            readyfunc, args=self._setupReadyStart(obj,*lst,**kw)
            host.WriteDebugf(["startafter"], "Setting ready logic to wait for object {0} with readyfunc {1}", obj, readyfunc)
    ...
    def EndBefore(self, *lst, **kw):
        ...
        for obj in lst:
            ...
            host.WriteDebugf(["endbefore"], "Setting ready logic to wait for object {0} with readyfunc {1}", obj, readyfunc)
